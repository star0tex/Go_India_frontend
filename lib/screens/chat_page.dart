// lib/customer/screens/chat_page.dart (or wherever your customer screens are)
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';
import '../services/socket_service.dart'; // ✅ Customer's socket service
...
class ChatPage extends StatefulWidget {
  ...
  const ChatPage({
    ...
    required this.receiverName, required bool isDriver,
  }) : super(key: key);
...
class _ChatPageState extends State<ChatPage> {
  ...
  final SocketService _socketService = SocketService(); // ✅ Customer socket service
  ...
  void _handleIncomingMessage(dynamic data) {
    ...
    try {
      ...
      if (senderId == widget.senderId) return;
